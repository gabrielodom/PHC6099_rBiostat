...
knitr:
  opts_chunk:      ########## set global options #######
    ...
    warning: false  # no show warnings
    error: false    # no show error messages
    comment: ""    # don't show ## with printed output
    R.options:    
      digits: 3    # round to three digits
bibliography: [06_power_ols_references.bib, 06_power_ols_packages.bib]
...
![Visual view of beta](06_power_ols_beta.png)
